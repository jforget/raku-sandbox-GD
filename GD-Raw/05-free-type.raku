...
gdImageStringFT($im, @bound-rect, $black, $fontpath, $fontsize,  π/2, 10, 110, "Vertical climb"); dump-bound(@bound-rect);
gdImageStringFT($im, @bound-rect, $black, $fontpath, $fontsize,  π/4, 20, 120, "Zoom climb"    ); dump-bound(@bound-rect);
gdImageStringFT($im, @bound-rect, $black, $fontpath, $fontsize,  0e0, 30, 130, "Level flight"  ); dump-bound(@bound-rect);
gdImageStringFT($im, @bound-rect, $black, $fontpath, $fontsize, -π/4, 20, 140, "Steep dive"    ); dump-bound(@bound-rect);
gdImageStringFT($im, @bound-rect, $black, $fontpath, $fontsize, -π/2, 10, 150, "Vertical dive" ); dump-bound(@bound-rect);
...
gdImageStringFT($im, @bound-rect, $blue, $fontalt, $fontsize, 0e0, 10, 250, $str1); dump-bound(@bound-rect);
gdImageStringFT($im, @bound-rect, $red , $fontalt, $fontsize, 0e0, 10, 280, $str2); dump-bound(@bound-rect);
